  ...
  <div class="space-y-6">
      ...
      <form @submit.prevent="saveSettings" class="space-y-6">
          ...
          <div class="flex space-x-4">
            <label class="inline-flex items-center">
              <input
                ...
                value="mailgun"
                class="form-radio text-amber-500 bg-gray-700 border-gray-600"
              />
        ...
        <div v-if="settings.mailer === 'mailgun'" class="space-y-4 p-4 bg-gray-900 rounded-lg">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                v-model="settings.mailgun_secret"
                type="password"
            ...
            <div>
              ...
              <select
                v-model="settings.mailgun_endpoint"
                class="w-full bg-gray-700 border border-gray-600 rounded-md px-3 py-2 text-white focus:ring-amber-500 focus:border-amber-500"
              >
        ...
        <div class="flex items-center space-x-4 pt-4 border-t border-gray-700">
          <button
            type="submit"
            :disabled="saving"
            class="px-4 py-2 bg-amber-500 text-black font-medium rounded-md hover:bg-amber-600 disabled:opacity-50"
          >
          ...
          <button
            ...
            class="px-4 py-2 bg-gray-600 text-white font-medium rounded-md hover:bg-gray-500 disabled:opacity-50"
          >
            Send Test Email
          </button>
        </div>
    ...
    <div v-if="activeTab === 'templates'" class="space-y-4">
      <div class="flex justify-between items-center">
        <button
          ...
          class="px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-md hover:bg-gray-500 disabled:opacity-50"
        >
          {{ seedingDefaults ? 'Creating...' : 'Create Default Templates' }}
        </button>
        <button
          @click="openTemplateModal()"
          class="px-4 py-2 bg-amber-500 text-black text-sm font-medium rounded-md hover:bg-amber-600"
        >
          + New Template
        </button>
      </div>
        ...
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-700">
            <tr v-for="template in templates" :key="template.id" class="hover:bg-gray-700">
              ...
              <td class="px-4 py-3">
                <span
                  :class="template.is_active ? 'bg-green-900 text-green-300' : 'bg-red-900 text-red-300'"
      ...
      <div class="bg-gray-800 rounded-lg p-6 w-full max-w-md">
        ...
        <div class="flex justify-end space-x-3">
          ...
          <button
            ...
            class="px-4 py-2 bg-amber-500 text-black rounded-md hover:bg-amber-600 disabled:opacity-50"
          >
        ...
        <form @submit.prevent="saveTemplate" class="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              placeholder="app_name, username, email"
              class="w-full bg-gray-700 border border-gray-600 rounded-md px-3 py-2 text-white placeholder-gray-400 focus:ring-amber-500 focus:border-amber-500"
            />
          ...
          <div>
            ...
            <textarea
              ...
              class="w-full bg-gray-700 border border-gray-600 rounded-md px-3 py-2 text-white placeholder-gray-400 focus:ring-amber-500 focus:border-amber-500 font-mono text-sm"
            ></textarea>
          </div>
    ...
    <div v-if="showPreviewModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-gray-800 rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div class="mt-4 flex justify-end space-x-3">
          <button
            @click="showSendTestTemplateModal = true"
            class="px-4 py-2 bg-amber-500 text-black rounded-md hover:bg-amber-600"
          >
            Send Test Email
          </button>
        </div>
    ...
    <div v-if="showSendTestTemplateModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60]">
      <div class="bg-gray-800 rounded-lg p-6 w-full max-w-md">
        ...
        <div class="flex justify-end space-x-3">
          <button
            @click="showSendTestTemplateModal = false"
            class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-500"
          >
            Cancel
          </button>
...
const variablesInput = computed({
  ...
  set: (val) => {
    editingTemplate.value.available_variables = val
      .split(',')
      .map(v => v.trim())
      .filter(v => v)
  }
